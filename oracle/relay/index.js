...
async function setupTelegram() {
  ...
  const profile=[
    ...
    ["setMyShortDescription",{short_description:"🔮 Персональный Оракул AI: Таро, карта дня, совместимость и сны. Начни бесплатно — ответ уже рядом ✦"}],
    ["setMyDescription",{description:"🔮 Мадам Агриппина — персональный Оракул AI, который помогает увидеть скрытые смыслы и взглянуть на ситуацию с новой стороны.\n\nВнутри:\n✦ карта дня с личным посланием\n♢ расклады Таро на 1, 3 или 7 карт\n◐ ответы о любви, деньгах и карьере\n∞ совместимость по датам рождения\n☾ толкование снов\n♡ история и избранное\n\nНачните бесплатно — 3 запроса каждый день. Нажмите «Старт», чтобы получить первое послание.\n\nДля развлечения и саморефлексии. 18+"}],
  ];
